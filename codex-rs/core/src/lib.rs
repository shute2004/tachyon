...
pub use codex_attachment_store::AttachmentMetadata;
pub use codex_attachment_store::AttachmentRef;
pub use codex_attachment_store::AttachmentStore;
pub use codex_attachment_store::AttachmentStoreError;
pub use codex_attachment_store::AttachmentStoreFuture;
pub use codex_attachment_store::AttachmentStoreResult;
pub use codex_attachment_store::InlineAttachmentStore;
...
pub use thread_manager::inline_attachment_store;
